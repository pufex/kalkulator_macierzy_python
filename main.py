...
class Window(qtw.QMainWindow):
    def __init__(self, ctx: CtxDict):
        ...
        self.toolbar.addAction(quick_load)
        ...
        self.toolbar.addAction(save_matrices)
        ...
        self.toolbar.addAction(save_matrices_quickly)
